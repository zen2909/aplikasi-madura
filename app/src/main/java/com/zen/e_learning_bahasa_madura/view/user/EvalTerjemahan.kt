...
class EvalTerjemahan : Activity() {
    ...
    private lateinit var binding: HalEvalTerjemahanBinding
            ...
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    if (idKoleksiAktif != null) {
                        ...
                        Toast.makeText(this@EvalTerjemahan, "Tidak ada koleksi aktif", Toast.LENGTH_SHORT).show()
                    }
                }
            ...
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    if (idPilganList.isEmpty()) {
                        Toast.makeText(this@EvalTerjemahan, "Belum ada soal dalam koleksi ini", Toast.LENGTH_SHORT).show()
                        return
                    }
